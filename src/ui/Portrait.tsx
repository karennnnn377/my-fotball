...
interface PortraitProps {
  ...
  /** Mystery mode: neutral silhouette + "?" — used BEFORE the answer so the
      correct team's colours are never leaked (spec #27). */
  mystery?: boolean;
}

export default function Portrait({ player, color, size = 92, showName = false, mystery = false }: PortraitProps) {
      ...
      >
        ...
        <g clipPath={`url(#${clipId})`}>
          ...
          {mystery ? (
            ...
            <g>
              <path d="M20 200 C24 150 52 128 78 122 L100 132 L122 122 C148 128 176 150 180 200 Z" fill={mysteryFill} stroke="#0a1730" strokeWidth="3" />
              <path d="M88 96 L88 128 C88 136 112 136 112 128 L112 96 Z" fill={mysteryFill} stroke="#0a1730" strokeWidth="2.5" />
              <ellipse cx="100" cy="66" rx="34" ry="39" fill={mysteryFill} stroke="#0a1730" strokeWidth="3" />
              <ellipse cx="66" cy="70" rx="6" ry="9" fill={mysteryFill} stroke="#0a1730" strokeWidth="2.5" />
              <ellipse cx="134" cy="70" rx="6" ry="9" fill={mysteryFill} stroke="#0a1730" strokeWidth="2.5" />
              ...
              <text
                ...
                fontFamily="var(--font-display)" fontSize="76" fontWeight="700"
                fill="#ffd257" stroke="#0a1730" strokeWidth="3" paintOrder="stroke"
        ...
        {mystery && <circle cx="100" cy="100" r="93" fill="none" stroke="#ffd257" strokeWidth="2.5" strokeDasharray="7 9" opacity="0.55" />}
      </svg>
      {showName && (
        <span
